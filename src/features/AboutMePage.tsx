	...
	return (
		...
		>
			...
			>
				...
				<CenterFocusStrongOutlinedIcon fontSize="large" sx={{ color: '#6eccfa' }}></CenterFocusStrongOutlinedIcon>
				<Typography >
				...
				<SelfImprovementOutlinedIcon fontSize="large" sx={{ color: '#6eccfa' }}></SelfImprovementOutlinedIcon>
				<Typography >
				...
				<SportsEsportsOutlinedIcon fontSize="large" sx={{ color: '#6eccfa' }}></SportsEsportsOutlinedIcon>
				<Typography >
